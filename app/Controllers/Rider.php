...
class Rider extends BaseController
{
	...
	public function detail($kd_driver)
	{
		...
		$bukti_attr = file_exists(FCPATH . '/../kajek/images/topup/' . $rider['bukti_bayar'] .'.jpg' . 'bukti_bayar.jpg') ? base_url() . '/../kajek/images/topup/' . $rider['bukti_bayar'] .'.jpg' . 'bukti_bayar' : base_url() . '/assets/file-not-found.png'; 
