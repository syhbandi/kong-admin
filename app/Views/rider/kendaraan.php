    ...
    <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
            <li class="nav-item text-dark">
                <a class="nav-link active text-dark" id="tab-baru" data-toggle="pill" href="#baru" role="tab"
                    aria-controls="baru" aria-selected="true"><i class="fas fa-plus-circle mr-1 text-info"></i> Baru</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" id="tab-aktif" data-toggle="pill" href="#aktif" role="tab"
                    aria-controls="aktif" aria-selected="false"><i class="fas fa-power-off mr-1 text-success"></i>
                    Aktif</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" id="tab-nonaktif" data-toggle="pill" href="#nonaktif" role="tab"
                    aria-controls="nonaktif" aria-selected="false"><i class="fas fa-power-off mr-1 text-danger"></i>
                    Nonaktif</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" id="tab-banned" data-toggle="pill" href="#banned" role="tab"
                    aria-controls="banned" aria-selected="false"><i class="fas fa-ban mr-1 text-danger"></i> Banned</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
