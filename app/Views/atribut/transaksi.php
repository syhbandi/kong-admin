  ...
  <div class="card-header p-0 border-bottom-0">
    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
      <li class="nav-item text-dark">
        <a class="nav-link active text-dark" id="tab-baru" data-toggle="pill" href="#baru" role="tab" aria-controls="aktif" aria-selected="true"><i class="fas fa-plus-circle mr-1 text-info"></i> Pembelian Baru</a>
      </li>
      <li class="nav-item text-dark">
        <a class="nav-link text-dark" id="tab-tab-tutup" data-toggle="pill" href="#tutup" role="tab" aria-controls="aktif" aria-selected="true"><i class="fas fa-power-off mr-1 text-warning"></i> Perbaikan</a>
      </li>
      <li class="nav-item text-dark">
        <a class="nav-link text-dark" id="tab-tab-banned" data-toggle="pill" href="#banned" role="tab" aria-controls="aktif" aria-selected="true"><i class="fas fa-check-double mr-1 text-success"></i> Selsai</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
